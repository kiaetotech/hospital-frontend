          ...
          <div style={{ backgroundColor: 'white', borderRadius: '12px', padding: '24px', maxWidth: '500px', width: '90%' }}>
            ...
            <form onSubmit={handleBookingSubmit}>
              ...
              <div style={{ marginTop: '20px', display: 'flex', gap: '10px' }}>
                ...
                <button type="button" onClick={() => { setShowBookingModal(false); setSelectedProvider(null); }} style={{ flex: 1, backgroundColor: '#6b7280', color: 'white', padding: '12px', border: 'none', borderRadius: '6px', cursor: 'pointer' }}>Cancel</button>
              </div>
            </form>
          </div>
        </div>
                  ...
                  <div key={category.code} style={{ marginBottom: '20px', border: `1px solid ${category.color}`, borderRadius: '8px', overflow: 'hidden' }}>
                    ...
                    {hasMore && expandedCategories[category.code] && (
                      <div style={{ padding: '8px', textAlign: 'center', backgroundColor: '#f3f4f6' }}>
                        <button onClick={() => showMoreTests(category.code)} style={{ backgroundColor: '#6b7280', color: 'white', padding: '5px 15px', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>Show More ({category.tests.length - visibleCount})</button>
                      </div>
                    )}
                  </div>
                );
