...
import AmbulanceConfirmation from './pages/AmbulanceConfirmation';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/financing" element={<Comingimport React from 'react';
import { BrowserRouter, Routes, Route } from 'react-router-dom';
...
export default App;Soon title="Health Financing" />} />
        <Route path="/teleconsult" element={<ComingSoon title="Teleconsultation" />} />
        <Route path="/corporate" element={<ComingSoon title="Corporate Health" />} />
      </Routes>
    </BrowserRouter>
